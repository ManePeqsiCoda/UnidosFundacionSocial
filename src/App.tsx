...
const TypewriterSubtitle = ({ text, delay = 1000 }: { text: string, delay?: number }) => {
  ...
  return (
    <p className="animate-fade-up" style={{ maxWidth: '560px', fontSize: '17px', color: 'rgba(255,255,255,0.7)', lineHeight: 1.8, marginTop: '24px', marginBottom: '40px', animationDelay: '0.4s', minHeight: '60px' }}>
      {displayedText}
...
const EventosSection = () => {
  ...
  return (
    <div className="reveal-hidden" style={{ background: '#FFFFFF', padding: '96px 80px' }}>
...
export const PublicLanding = ({ onLogin }: { onLogin: () => void }) => {
  ...
  return (
    <div style={{ width: '100%' }}>
      {/* Navbar */}
      <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', padding: '24px 48px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 20 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <div className="hidden-mobile" style={{ display: 'flex', gap: '32px' }}>
          {['Inicio', 'Transparencia', 'Impacto', 'Contacto'].map(link => (
            <a key={link} href="#" className="nav-link" style={{ color: '#FFFFFF', fontSize: '14px', fontWeight: 600 }}>{link}</a>
          ))}
        </div>
      </div>
      ...
      {/* Main Content */}
      <div style={{ position: 'relative', zIndex: 10, maxWidth: '1200px', width: '100%', display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: 'center', justifyContent: 'space-between', paddingBottom: '100px', gap: '48px' }}>
        ...
        <div style={{ flex: isMobile ? '1 1 100%' : '0 0 55%', display: 'flex', flexDirection: 'column', alignItems: isMobile ? 'center' : 'flex-start', textAlign: isMobile ? 'center' : 'left' }}>
          {/* Badge */}
          <div className="glass-card animate-fade-up" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '8px 16px', borderRadius: '9999px', marginBottom: '32px' }}>
            <Sparkles size={16} color="#C5A059" style={{ animation: 'pulseGold 2s infinite' }} />
            <span style={{ color: '#E8D09A', fontSize: '12px', fontWeight: 700, letterSpacing: '0.1em' }}>
              TRANSFORMACIÓN DIGITAL B2G · BOYACÁ 2025
            </span>
          </div>

          {/* Headline */}
          <h1 style={{ margin: 0, display: 'flex', flexDirection: 'column', gap: '8px', letterSpacing: '-0.045em', alignItems: isMobile ? 'center' : 'flex-start' }}>
            <span className="animate-fade-up" style={{ color: '#FFFFFF', fontWeight: 900, fontSize: '64px', lineHeight: 1.1, animationDelay: '0.1s' }}>
              El Salto Definitivo:
            </span>
            <span className="animate-fade-up" style={{ color: '#E8D09A', fontWeight: 900, fontSize: '64px', lineHeight: 1.1, animationDelay: '0.2s' }}>
              De Proveedor Tradicional
            </span>
            <span className="text-glow-gold typewriter-text" style={{ color: '#C5A059', fontWeight: 900, fontSize: '64px', lineHeight: 1.1 }}>
          ...
          {/* Features Pills */}
          <div className="animate-fade-up" style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: isMobile ? 'center' : 'flex-start', gap: '12px', marginBottom: '48px', animationDelay: '0.5s' }}>
            {["13 Provincias", "47 Licitaciones / Año", "Ley 1712 ✓", "PNUD Alineada", "IA Integrada"].map((feature, i, arr) => (
              <React.Fragment key={feature}>
                <span className="feature-pill" style={{ padding: '6px 14px', borderRadius: '9999px', fontSize: '13px', fontWeight: 600, color: '#E8D09A', cursor: 'default' }}>
                  {feature}
                </span>
          ...
          <div className="animate-fade-up" style={{ display: 'flex', gap: '16px', animationDelay: '0.6s', justifyContent: isMobile ? 'center' : 'flex-start' }}>
            <button onClick={onLogin} className="btn-primary" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '14px 28px', borderRadius: '8px', border: 'none', color: '#00163A', fontWeight: 700, fontSize: '15px', cursor: 'pointer', transition: 'all 0.2s ease' }}>
              <Lock size={18} />
              Acceso Institucional
            </button>
            <button className="btn-secondary" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '14px 28px', borderRadius: '8px', color: '#E8D09A', fontWeight: 600, fontSize: '15px', cursor: 'pointer', transition: 'all 0.2s ease' }}>
              Ver Portal Público
            </button>
          </div>
        </div>
        ...
        {!isMobile && (
          <div style={{ flex: '0 0 45%', display: 'flex', justifyContent: 'flex-end', paddingLeft: '32px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gridTemplateRows: '260px 180px 160px', gap: '8px', width: '100%', maxWidth: '460px' }}>
              {/* img1 */}
              <div className="animate-fade-up" style={{ gridColumn: '1 / span 2', borderRadius: '12px', border: '2px solid rgba(197,160,89,0.25)', overflow: 'hidden', position: 'relative', animationDelay: '0.3s', transition: 'all 0.3s ease' }}
                   onMouseEnter={(e) => { e.currentTarget.style.borderColor = '#C5A059'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(197,160,89,0.3)'; }}
                   onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'rgba(197,160,89,0.25)'; e.currentTarget.style.boxShadow = 'none'; }}>
                <img src="https://picsum.photos/seed/boyaca-familia/400/260" alt="Boyacá Familia" style={{ width: '100%', height: '100%', objectFit: 'cover' }} referrerPolicy="no-referrer" />
                <div style={{ position: 'absolute', bottom: '12px', left: '12px', background: 'rgba(0,22,58,0.8)', padding: '4px 8px', borderRadius: '4px', color: '#E8D09A', fontSize: '11px', fontWeight: 700 }}>Boyacá · 13 Provincias</div>
              </div>
              {/* img2 */}
              <div className="animate-fade-up" style={{ borderRadius: '12px', border: '2px solid rgba(197,160,89,0.25)', overflow: 'hidden', animationDelay: '0.5s', transition: 'all 0.3s ease' }}
                   onMouseEnter={(e) => { e.currentTarget.style.borderColor = '#C5A059'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(197,160,89,0.3)'; }}
                   onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'rgba(197,160,89,0.25)'; e.currentTarget.style.boxShadow = 'none'; }}>
                <img src="https://picsum.photos/seed/evento-social/190/180" alt="Evento Social" style={{ width: '100%', height: '100%', objectFit: 'cover' }} referrerPolicy="no-referrer" />
              </div>
              {/* img3 */}
              <div className="animate-fade-up" style={{ borderRadius: '12px', border: '2px solid rgba(197,160,89,0.25)', overflow: 'hidden', animationDelay: '0.7s', transition: 'all 0.3s ease' }}
                   onMouseEnter={(e) => { e.currentTarget.style.borderColor = '#C5A059'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(197,160,89,0.3)'; }}
                   onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'rgba(197,160,89,0.25)'; e.currentTarget.style.boxShadow = 'none'; }}>
                <img src="https://picsum.photos/seed/comunidad-col/190/180" alt="Comunidad" style={{ width: '100%', height: '100%', objectFit: 'cover' }} referrerPolicy="no-referrer" />
              </div>
              {/* img4 */}
              <div className="animate-fade-up" style={{ gridColumn: '1 / span 2', borderRadius: '12px', border: '2px solid rgba(197,160,89,0.25)', overflow: 'hidden', animationDelay: '0.9s', transition: 'all 0.3s ease' }}
                   onMouseEnter={(e) => { e.currentTarget.style.borderColor = '#C5A059'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(197,160,89,0.3)'; }}
                   onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'rgba(197,160,89,0.25)'; e.currentTarget.style.boxShadow = 'none'; }}>
                <img src="https://picsum.photos/seed/feria-pueblo/400/160" alt="Feria Pueblo" style={{ width: '100%', height: '100%', objectFit: 'cover' }} referrerPolicy="no-referrer" />
              </div>
            </div>
          </div>
        )}
      ...
      <div className="animate-fade-up" style={{ position: 'absolute', bottom: 0, left: 0, width: '100%', borderTop: '1px solid rgba(197,160,89,0.2)', background: 'rgba(0,22,58,0.8)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', zIndex: 10, animationDelay: '0.8s', overflowX: 'auto' }}>
        <div style={{ minWidth: '800px', maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', padding: '24px 0' }}>
      ...
      <div className="reveal-hidden" style={{ background: '#00163A', padding: '40px 24px', borderBottom: '1px solid rgba(197,160,89,0.2)' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap', gap: '24px' }}>
          <LargeStatItem target={3.4} decimals={1} prefix="$" suffix="B COP" label="Total ejecutado 2023-2025" />
          <div style={{ width: '1px', height: '60px', background: 'rgba(197,160,89,0.2)', display: 'block' }} className="hidden-mobile" />
          <LargeStatItem target={47} suffix=" contratos" label="Adjudicados en Boyacá" />
          <div style={{ width: '1px', height: '60px', background: 'rgba(197,160,89,0.2)', display: 'block' }} className="hidden-mobile" />
          <LargeStatItem target={13} suffix=" municipios" label="Con presencia activa" />
        </div>
      </div>

      {/* Ticker de Artistas / Catálogo (Marquee) */}
      <div className="reveal-hidden" style={{ background: '#002147', padding: '48px 0', overflow: 'hidden', borderBottom: '1px solid rgba(197,160,89,0.1)' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <h2 style={{ color: '#FFFFFF', fontSize: '24px', fontWeight: 800, margin: 0 }}>Catálogo de Artistas y Servicios</h2>
          <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '14px', marginTop: '8px' }}>Talento local y logística de primer nivel para sus eventos institucionales</p>
        </div>
        <div className="marquee-track" style={{ gap: '32px', padding: '0 16px' }}>
          {[
            "Orquesta Sinfónica de Boyacá", "Grupo de Danzas Folclóricas", "Sonido Line Array 20.000W", 
            "Tarimas Certificadas", "Pantallas LED P3", "Iluminación Robótica", 
            "Logística Especializada", "Catering VIP", "Presentadores Oficiales",
            "Orquesta Sinfónica de Boyacá", "Grupo de Danzas Folclóricas", "Sonido Line Array 20.000W", 
            "Tarimas Certificadas", "Pantallas LED P3", "Iluminación Robótica", 
            "Logística Especializada", "Catering VIP", "Presentadores Oficiales"
          ].map((item, i) => (
      ...
      {/* Mapa Territorial (Hexágonos) */}
      <div className="reveal-hidden" style={{ background: '#00163A', padding: '80px 48px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <SecTitle 
            title="Presencia Territorial" 
            subtitle="Operación activa en las 13 provincias de Boyacá"
          />
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '16px', marginTop: '48px', maxWidth: '800px' }}>
            {['Tunja', 'Duitama', 'Sogamoso', 'Chiquinquirá', 'Puerto Boyacá', 'Paipa', 'Villa de Leyva', 'Moniquirá', 'Garagoa', 'Guateque', 'Ramiriquí', 'Soatá', 'El Cocuy'].map((mun, i) => (
              <div key={i} className={i % 3 === 0 ? "hex-active" : ""} style={{
                width: '120px',
                height: '138px',
                background: i % 3 === 0 ? 'linear-gradient(135deg, #C5A059 0%, #9A7A3A 100%)' : 'rgba(255,255,255,0.05)',
                ...
                textAlign: 'center',
                padding: '16px',
                color: i % 3 === 0 ? '#00163A' : '#FFFFFF',
                fontWeight: 700,
                fontSize: '13px',
                border: i % 3 !== 0 ? '1px solid rgba(197,160,89,0.2)' : 'none',
                transition: 'all 0.3s ease',
                cursor: 'pointer'
              }}>
                {mun}
      ...
      <div className="reveal-hidden" style={{ background: 'linear-gradient(180deg, #F7F8FA 0%, #FFFFFF 100%)', padding: '80px 48px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <SecTitle 
          ...
          <div className="cases-grid" style={{ marginTop: '48px' }}>
            {casos.map((caso, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ padding: '24px', paddingTop: '16px', display: 'flex', flexDirection: 'column', gap: '12px', flex: 1 }}>
                    {/* 1. Fila superior */}
      ...
      <div className="reveal-hidden" style={{ background: '#F3F4F6', padding: '80px 48px 0 48px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <SecTitle 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px', marginTop: '48px', paddingBottom: '80px' }}>
